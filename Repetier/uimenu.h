...
#ifdef BTENABLED
  UI_MENU_ACTIONCOMMAND(ui_menu_quick_serial,UI_TEXT_SERIAL,UI_ACTION_SERIAL);   //  SETUP BT SERIAL  =================================
  #define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all BABY_ENTRY ,&ui_menu_quick_speedmultiply,&ui_menu_quick_flowmultiply UI_TOOGLE_LIGHT_ENTRY ,&ui_menu_quick_preheat_pla,&ui_menu_quick_preheat_abs,&ui_menu_quick_cooldown,&ui_menu_quick_origin,&ui_menu_quick_serial,&ui_menu_quick_stopstepper MENU_PSON_ENTRY DEBUG_PRINT_EXTRA}
...
#ifdef BTENABLED 
  UI_MENU_ACTIONCOMMAND(ui_menu_general_serial,UI_TEXT_SERIAL,UI_ACTION_SERIAL);   //  SETUP BT SERIAL
  #define UI_MENU_GENERAL {UI_MENU_ADDCONDBACK &ui_menu_general_baud,&ui_menu_general_serial,&ui_menu_general_stepper_inactive,&ui_menu_general_max_inactive}
  UI_MENU(ui_menu_general,UI_MENU_GENERAL,4+UI_MENU_BACKCNT);
#else
