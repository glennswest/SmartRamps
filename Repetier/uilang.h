...
#define UI_TEXT_ON               "\x7f"							//寮€On "On"
#define UI_TEXT_OFF              "\x80" 						//鍏砄ff "Off"
#define UI_TEXT_NA               "\x81" 						//鏃?"N/A" // Output for not available
#define UI_TEXT_YES              "\x82" 						//鏄?"Yes"
#define UI_TEXT_NO               "\x83" 						//鍚?"No"
#define UI_TEXT_SEL              "\003"
#define UI_TEXT_NOSEL            "\004"
#define UI_TEXT_PRINT_POS        "\x84\x85..."   					//鎵撳嵃"Printing..." 
#define UI_TEXT_PRINTING         "\x84\x85\x86" 				//鎵撳嵃涓?Printing"
#define UI_TEXT_IDLE             "\x87\x88" 					//绌洪棽"Idle"
#define UI_TEXT_NOSDCARD         "\x81 SD \x89" 				// 鏃燬D鍗?No SD Card"
#define UI_TEXT_ERROR            "**** \x8a\x8b ****" 					// 閿欒"**** ERROR ****"
#define UI_TEXT_BACK             "\x8c\x8d \001" 					// 杩斿洖"Back \001"
#define UI_TEXT_QUICK_SETTINGS   "\x8e\x8f\x90\x91" 			//蹇€熻缃?Quick Settings"
#define UI_TEXT_CONFIGURATION    "\x92\x91" 					//閰嶇疆"Configuration"
#define UI_TEXT_POSITION         "\x93\x91" 					//浣嶇疆"Position"
#define UI_TEXT_EXTRUDER         "\x94\x95\xcb" 				//鎸ゅ嚭鏈?Extruder"
#define UI_TEXT_SD_CARD          "SD \x89" 						//SD 鍗?SD Card"
#define UI_TEXT_DEBUGGING        "\x96\x97"						//璋冭瘯"Debugging"
#define UI_TEXT_HOME_DELTA       "\xa0\x93 Delta"					//"Home Delta"
#define UI_TEXT_HOME_ALL         "\xa0\x93"						//褰掍綅"Home All"
#define UI_TEXT_HOME_X           "X \xa0\x93"					//"Home X"
#define UI_TEXT_HOME_Y           "Y \xa0\x93"					//"Home Y"
#define UI_TEXT_HOME_Z           "Z \xa0\x93"					//"Home Z"
#define UI_TEXT_PREHEAT_PLA      "\x98\x99 PLA" 				//棰勭儹PLA"Preheat PLA"
#define UI_TEXT_PREHEAT_ABS      "\x98\x99 ABS" 				//棰勭儹ABS"Preheat ABS"
#define UI_TEXT_COOLDOWN         "\x9a\x9b" 					// 闄嶆俯"Cooldown"
#define UI_TEXT_LIGHTS_ONOFF     "\xfb\xfc :%lo"					//鐏厜"Lights :%lo"
#define UI_TEXT_SET_TO_ORIGIN    "\x90\x9c\x9d\x9e" 			//璁惧畾鍘熺偣"Set to Origin"
#define UI_TEXT_DISABLE_STEPPER  "\x80\x9f\xc0\xc1\xca\xcb" 	//鍏抽棴姝ヨ繘鐢垫満"Disable stepper"
#define UI_TEXT_X_POSITION       "X \x93\x91"					//X浣嶇疆"X Position"
#define UI_TEXT_X_POS_FAST       "X \x93\x91(\x8e\x8f)"			//X浣嶇疆锛堝揩閫燂級"X Pos. Fast"
#define UI_TEXT_Y_POSITION       "Y \x93\x91"					//"Y Position"
#define UI_TEXT_Y_POS_FAST       "Y \x93\x91(\x8e\x8f)"			//"Y Pos. Fast"
#define UI_TEXT_Z_POSITION       "Z \x93\x91"					//"Z Position"
#define UI_TEXT_Z_POS_FAST       "Z \x93\x91(\x8e\x8f)"			//"Z Pos. Fast"
#define UI_TEXT_E_POSITION       "E \x93\x91"					//"Extr. position"
#define UI_TEXT_BED_TEMP         "\x99\xc4\x9b\xc5: %Eb\002C" 	// 鐑簥娓╁害 "Bed temp: %Eb\002C"
#define UI_TEXT_EXTR0_TEMP       "\x9b\xc5 1:  %E0\002C"		//娓╁害 1"Temp. 1:  %E0\002C"			//
#define UI_TEXT_EXTR1_TEMP       "\x9b\xc5 2:  %E1\002C"		//"Temp. 2:  %E1\002C"
#define UI_TEXT_EXTR2_TEMP       "\x9b\xc5 3:  %E2\002C"		//"Temp. 2:  %E2\002C"
#define UI_TEXT_EXTR0_OFF        "\x94\x95\xcb 1 \x80\x9f"		//鎸ゅ嚭鏈?1 鍏抽棴"Extruder 1 Off"				//
#define UI_TEXT_EXTR1_OFF        "\x94\x95\xcb 2 \x80\x9f"		//"Extruder 2 Off"
#define UI_TEXT_EXTR2_OFF        "\x94\x95\xcb 3 \x80\x9f"		//"Extruder 3 Off"
#define UI_TEXT_EXTR0_SELECT     "%X0 \xa1\xa2\x94\x95\xcb 1"	//閫夋嫨鎸ゅ嚭鏈?1"%X0 Select Extr. 1"
#define UI_TEXT_EXTR1_SELECT     "%X1 \xa1\xa2\x94\x95\xcb 2"	//"%X1 Select Extr. 2"
#define UI_TEXT_EXTR2_SELECT     "%X1 \xa1\xa2\x94\x95\xcb 3"	//"%X1 Select Extr. 3"
#define UI_TEXT_EXTR_ORIGIN      "\x90\x91\x9d\x9e"				//璁剧疆鍘熺偣"Set Origin"
#define UI_TEXT_PRINT_X          "\x84\x85 X:%ax"				//鎵撳嵃 X"Print X:%ax"
#define UI_TEXT_PRINT_Y          "\x84\x85 Y:%ay"				//"Print Y:%ay"
#define UI_TEXT_PRINT_Z          "\x84\x85 Z:%az"				//"Print Z:%az"
#define UI_TEXT_PRINT_Z_DELTA    "\x84\x85:%az"					//"Print:%az"
#define UI_TEXT_MOVE_X           "\xa4\xc3 X:%aX"				//绉诲姩 X"Move X:%aX"
#define UI_TEXT_MOVE_Y           "\xa4\xc3 Y:%aY"				//"Move Y:%aY"
#define UI_TEXT_MOVE_Z           "\xa4\xc3 Z:%aZ"				//"Move Z:%aZ"
#define UI_TEXT_MOVE_Z_DELTA     "\xa4\xc3:%aZ"					//"Move:%aZ"
#define UI_TEXT_JERK             "\xa5\xc3:%aj"					//鎶栧姩"Jerk:%aj"
#define UI_TEXT_ZJERK            "Z-\xa5\xc3:%aJ"				//"Z-Jerk:%aJ"
#define UI_TEXT_ACCELERATION     "\xa3\x8f"						//鍔犻€?Acceleration"
#define UI_TEXT_STORE_TO_EEPROM  "\xa6\xa8 EEPROM"                     //瀛樺叆eeprom"Store to EEPROM"
#define UI_TEXT_LOAD_EEPROM      "\xaa\xa8 EEPROM"                     //杞藉叆eeprom"Load f. EEPROM"
#define UI_TEXT_DBG_ECHO         "\xab\xac   :%do"                     //鏄剧ず"Echo   :%do"
#define UI_TEXT_DBG_INFO         "\xad\xae   :%di"                     //淇℃伅"Info   :%di"
#define UI_TEXT_DBG_ERROR        "\x8a\x8b   :%de"                       //"Errors :%de"
#define UI_TEXT_DBG_DRYRUN       "\x97\xf0\xde:%dd"                    //璇曚竴涓?Dry run:%dd"
#define UI_TEXT_OPS_OFF          "%O0 OPS \x80\x9f"                    //ops 鍏抽棴"%O0 OPS Off"
#define UI_TEXT_OPS_CLASSIC      "%O1 OPS \xe5\xe7"                    //ops 甯哥敤"%O1 OPS Classic"
#define UI_TEXT_OPS_FAST         "%O2 OPS \x8e\x8f"                    //"%O2 OPS Fast"
#define UI_TEXT_OPS_RETRACT      "\x8d\xaf :%Or"                     	//鍥炴娊"Retract :%Or"
#define UI_TEXT_OPS_BACKSLASH    "Backsl. :%Ob"                      	//"Backsl. :%Ob"
#define UI_TEXT_OPS_MINDIST      "Min.dist:%Od"                      	//"Min.dist:%Od"
#define UI_TEXT_OPS_MOVE_AFTER   "Move after:%Oa"                    	//"Move after:%Oa"
#define UI_TEXT_ANTI_OOZE        "\xcd\xb1\xaf\xce"                    //闃叉鎶戒笣"Anti Ooze"
#define UI_TEXT_PRINT_FILE       "\x84\x85\xcf\xd0"                    //鎵撳嵃鏂囨。"Print file"
#define UI_TEXT_PAUSE_PRINT      "\xd1\xb0\x84\x85"                    //鏆傚仠鎵撳嵃"Pause Print"
#define UI_TEXT_CONTINUE_PRINT   "\xd2\xd3\x84\x85"                    //缁х画鎵撳嵃"Continue Print"
#define UI_TEXT_UNMOUNT_CARD     "\xd4\xaa\xa6\xa7\x89"                //鍗歌浇瀛樺偍鍗?Unmount Card"
#define UI_TEXT_MOUNT_CARD       "\xa3\xaa\xa6\xa7\x89"                //鍔犺浇瀛樺偍鍗?Mount Card"
#define UI_TEXT_DELETE_FILE      "\xa4\xd5\xcf\xd0"                    //绉婚櫎鏂囦欢"Delete file"
#define UI_TEXT_FEEDRATE         "\x8f\xd6"                            //閫熺巼"Feedrate"
#define UI_TEXT_FEED_MAX_X       "\xd7\xd8 X:%fx"                      //鏈€澶?X"Max X:%fx"
#define UI_TEXT_FEED_MAX_Y       "\xd7\xd8 Y:%fy"                      //"Max Y:%fy"
#define UI_TEXT_FEED_MAX_Z       "\xd7\xd8 Z:%fz"                      //"Max Z:%fz"
#define UI_TEXT_FEED_MAX_Z_DELTA "\xd7\xd8:%fz"                        //"Max:%fz"
#define UI_TEXT_FEED_HOME_X      "\xa0\x93 X:%fX"                      //褰掍綅 X"Home X:%fX"
#define UI_TEXT_FEED_HOME_Y      "\xa0\x93 Y:%fY"                      //"Home Y:%fY"
#define UI_TEXT_FEED_HOME_Z      "\xa0\x93 Z:%fZ"                      //"Home Z:%fZ"
#define UI_TEXT_FEED_HOME_Z_DELTA "\xa0\x93:%fZ"                        //"Home:%fZ"
#define UI_TEXT_ACTION_XPOSITION4 "X:%x0 mm","\xd7\xd9\xf1\x93:%sx","\xd7\xd8\xf1\x93:%sX",""            //鏈€灏忛檺浣嶏紝鏈€澶ч檺浣?X:%x0 mm","Min endstop:%sx","Max endstop:%sX",""
#define UI_TEXT_ACTION_YPOSITION4 "Y:%x1 mm","\xd7\xd9 endstop:%sy","\xd7\xd8\xf1\x93:%sY",""            //"Y:%x1 mm","Min endstop:%sy","Max endstop:%sY",""
#define UI_TEXT_ACTION_ZPOSITION4 "Z:%x2 mm","\xd7\xd9 endstop:%sz","\xd7\xd8\xf1\x93:%sZ",""            //"Z:%x2 mm","Min endstop:%sz","Max endstop:%sZ",""
#define UI_TEXT_ACTION_XPOSITION_FAST4 "X:%x0 mm","\xd7\xd9\xf1\x93:%sx","\xd7\xd8\xf1\x93:%sX",""      //"X:%x0 mm","Min endstop:%sx","Max endstop:%sX",""
#define UI_TEXT_ACTION_YPOSITION_FAST4 "Y:%x1 mm","\xd7\xd9\xf1\x93:%sy","\xd7\xd8\xf1\x93:%sY",""        //"Y:%x1 mm","Min endstop:%sy","Max endstop:%sY",""
#define UI_TEXT_ACTION_ZPOSITION_FAST4 "Z:%x2 mm","\xd7\xd9\xf1\x93:%sz","\xd7\xd8\xf1\x93:%sZ",""      //"Z:%x2 mm","Min endstop:%sz","Max endstop:%sZ",""
#define UI_TEXT_ACTION_EPOSITION_FAST2 "E:%x3 mm","\xf2\xf3 = 1 mm"          							//"E:%x3 mm","1 click = 1 mm"
#define UI_TEXT_ACTION_XPOSITION2 "X:%x0 mm","\xd7\xd9:%sx \xd7\xd8:%sX"                                //"X:%x0 mm","Min:%sx Max:%sX"
#define UI_TEXT_ACTION_YPOSITION2 "Y:%x1 mm","\xd7\xd9:%sy \xd7\xd8:%sY"                                //"Y:%x1 mm","Min:%sy Max:%sY"
#define UI_TEXT_ACTION_ZPOSITION2 "Z:%x2 mm","\xd7\xd9:%sz \xd7\xd8:%sZ"                                //"Z:%x2 mm","Min:%sz Max:%sZ"
#define UI_TEXT_ACTION_XPOSITION_FAST2 "X:%x0 mm","\xd7\xd9:%sx \xd7\xd8:%sX"		//鏈€灏忥細鏈€澶?X:%x0 mm","Min:%sx Max:%sX"
#define UI_TEXT_ACTION_YPOSITION_FAST2 "Y:%x1 mm","\xd7\xd9:%sy \xd7\xd8:%sY"		//"Y:%x1 mm","Min:%sy Max:%sY"
#define UI_TEXT_ACTION_ZPOSITION_FAST2 "Z:%x2 mm","\xd7\xd9:%sz \xd7\xd8:%sZ"		//"Z:%x2 mm","Min:%sz Max:%sZ"
#define UI_TEXT_FANSPEED          "\xc6\xc7\x8f\xc5" 					//椋庢墖閫熷害Fan speed "Fan speed"
#define UI_TEXT_ACTION_FANSPEED   "\xc6\xc7\x8f\xc5:%Fs%%%"				//椋庢墖閫熷害"Fan speed:%Fs%%%"
#define UI_TEXT_FAN_OFF           "\x80\x9f\xc6\xc7"					//鍏抽棴椋庢墖"Turn Fan Off"	
#define UI_TEXT_FAN_25            "\x90\x91\xc6\xc7: 25%%%" 			//璁剧疆椋庢墖Set Fan 25%%%"
#define UI_TEXT_FAN_50            "\x90\x91\xc6\xc7: 50%%%"				//璁剧疆椋庢墖"Set Fan 50%%%"
#define UI_TEXT_FAN_75            "\x90\x91\xc6\xc7: 75%%%"				//璁剧疆椋庢墖"Set Fan 75%%%"
#define UI_TEXT_FAN_FULL          "\x90\x91\xc6\xc7: 100%%%"			//璁剧疆椋庢墖:100%"Set Fan Full"
#define UI_TEXT_STEPPER_INACTIVE  "\x80\x9f\xc0\xc1\xca\xcb"			//鍏抽棴姝ヨ繘鐢垫満"Stepper Inactive"
#define UI_TEXT_STEPPER_INACTIVE2 "\xf4\xe3\x80\x9f\xc0\xc1\xca\xcb:%is","[s] 0=\x80\x9f"	//寤舵椂鍏抽棴姝ヨ繘鐢垫満"Dis. After:%is","[s] 0=Off"
#define UI_TEXT_POWER_INACTIVE    "\x80\x9f\xca\xe6"										//鍏抽棴鐢垫簮"Max. Inactive"
#define UI_TEXT_POWER_INACTIVE2   "\xf4\xe3\x80\x9f\xca\xe6:%ip","[s] 0=\x80\x9f"			//"Dis. After:%ip","[s] 0=Off"
#define UI_TEXT_GENERAL           "\xe5\xe7"												//甯哥敤"General"
#define UI_TEXT_BAUDRATE          "\xed\xee\xd6:%oc"										//姣旂壒鐜?Baudrate:%oc"

#define UI_TEXT_EXTR_STEPS        "\xc0\xc1/MM:%Se"											//姝ヨ繘/MM"Steps/MM:%Se"
#define UI_TEXT_EXTR_START_FEED   "\x7f\xda\x8f\xd6:%Xf"									//寮€濮嬮€熺巼"Start FR:%Xf"
#define UI_TEXT_EXTR_MAX_FEED     "\xd7\xd9\x8f\xd6:%XF"									//鏈€澶ч€熺巼"Max FR:%XF"
#define UI_TEXT_EXTR_ACCEL        "\xa3\x8f:%XA"											//鍔犻€?Accel:%XA"
#define UI_TEXT_EXTR_WATCH        "Stab.Time:%Xw"
#define UI_TEXT_EXTR_ADVANCE_L    "Advance lin:%Xl"
#define UI_TEXT_EXTR_ADVANCE_K    "Advance quad:%Xa"
#define UI_TEXT_EXTR_MANAGER      "\xdb\xdc:%Xh"											//鎺у埗"Control:%Xh"							銆併€?#define UI_TEXT_EXTR_PGAIN        "DT/PID P:%Xp"
#define UI_TEXT_EXTR_IGAIN        "PID I:%Xi"
#define UI_TEXT_EXTR_DGAIN        "PID D:%Xd"
#define UI_TEXT_EXTR_DMIN         "\xd7\xd9\xc2\xc3:%Xm"									//鏈€灏忛┍鍔?Drive Min:%Xm"
#define UI_TEXT_EXTR_DMAX         "\xd7\xd8\xc2\xc3:%XM"									//鏈€澶ч┍鍔?Drive Max:%XM"
#define UI_TEXT_EXTR_PMAX         "\xd7\xd8 PID:%XD"										//鏈€澶ID"PID Max:%XD"
#define UI_TEXT_EXTR_XOFF         "X-\x93\xa4:%Xx" 											//浣嶇Щ"X-Offset:%Xx"
#define UI_TEXT_EXTR_YOFF         "Y-\x93\xa4:%Xy" 											//浣嶇Щ"Y-Offset:%Xy"
#define UI_TEXT_STRING_HM_BANGBANG "BangBang"
#define UI_TEXT_STRING_HM_PID     "PID"
#define UI_TEXT_STRING_ACTION     "xc3\xfe:%la"												//鍔ㄤ綔"Action:%la"
#define UI_TEXT_HEATING_EXTRUDER  "\x94\x95\xcb\xa3\x99\x86"								//鎸ゅ嚭鏈虹儹涓?Heating Extruder"
#define UI_TEXT_HEATING_BED       "\x99\xc4\xa3\x99\x86"									//鐑簥鍔犵儹涓?Heating Bed"
#define UI_TEXT_KILLED            "Killed"													//鏉€姝?
#define UI_TEXT_STEPPER_DISABLED  "\xc0\xc1\xca\xcb\xcc\x80\x9f" 							//姝ヨ繘鐢垫満宸插叧闂?Stepper Disabled"
#define UI_TEXT_EEPROM_STORED     "\x92\x91","\xcc\xa6\xa8 EEPROM"							//閰嶇疆,宸插瓨鍏eprom"Configuration","stored in EEPROM"
#define UI_TEXT_EEPROM_LOADED     "\x92\x91","\xcc\xaa\xa8 EEPROM"							//閰嶇疆,宸茶浇鍏eprom"Configuration","loaded f. EEPROM"
#define UI_TEXT_UPLOADING         "\xdd\xdf..."												//涓婁紶"Uploading..."
#define UI_TEXT_PAGE_BUFFER       "Buffer:%oB"												//"Buffer:%oB"
#define UI_TEXT_PAGE_EXTRUDER     " E:%ec/%Ec\002C\176%oC"
#define UI_TEXT_PAGE_EXTRUDER1     "E1:%e0/%E0\002C\176%o0"
#define UI_TEXT_PAGE_EXTRUDER2     "E2:%e1/%E1\002C\176%o1"
#define UI_TEXT_PAGE_EXTRUDER3     "E3:%e2/%E2\002C\176%o2"
#define UI_TEXT_PAGE_BED          " B:%eb/%Eb\002C\176%ob"
#define UI_TEXT_SPEED_MULTIPLY    "\x8f\xd6:%om%%%"							// 閫熺巼"Speed Mul.:%om%%%"
#define UI_TEXT_FLOW_MULTIPLY     "\xe1\xe2:%of%%%" 						// 娴侀噺Flow Mul.:%of%%%"
#define UI_TEXT_EXTR_WAIT_RETRACT_TEMP  "\xe9\xea\xa3\x99:%XT\002C"			// 绛夊緟鍔犵儹"Wait Temp.%XT\002C"
#define UI_TEXT_EXTR_WAIT_RETRACT_UNITS "\xe9\xea\x8d\xaf:%XUmm"			// 绛夊緟鍥炴娊"Wait Units:%XUmm"
#define UI_TEXT_PRINTER_READY    "\xc8\xc9\x84\x85" 						//鍑嗗鎵撳嵃 "Printer ready."
// Printtime output gets aggregated like <Days_5gisgits>UI_TEXT_PRINTTIME_DAYS<Hours>UI_TEXT_PRINTTIME_HOURS<Minutes>UI_TEXT_PRINTTIME_MINUTES
// ___88 days 12:45
#define UI_TEXT_PRINTTIME_DAYS   " \xe8 "									//澶? days "
#define UI_TEXT_PRINTTIME_HOURS  ":"
#define UI_TEXT_PRINTTIME_MINUTES ""
#define UI_TEXT_PRINT_TIME     "\x84\x85\xe3\xe4"							//鎵撳嵃鏃堕棿"Printing time"
#define UI_TEXT_PRINT_FILAMENT "\xcc\xe7\x84\x85\xce"						//宸茬敤鎵撳嵃涓?Filament printed" 
#define UI_TEXT_POWER            "ATX \xca\xe6\x7f/\x80" 					//鐢垫簮寮€鍏?ATX power on/off"
#define UI_TEXT_STRING_HM_DEADTIME     "Dead Time"
#define UI_TEXT_STRING_HM_SLOWBANG     "SlowBang"
#define UI_TEXT_STOP_PRINT "\xb0\xb1\x84\x85"								// 鍋滄鎵撳嵃"Stop Print"

#define UI_TEXT_SHOW_MEASUREMENT  "\xab\xac\xf7\xf8"						//鏄剧ず灏哄"Show meas."
#define UI_TEXT_RESET_MEASUREMENT "\xf6\x91\xf7\xf8"						//閲嶇疆灏哄"Reset meas."
#define UI_TEXT_SET_MEASURED_ORIGIN "\x90\x91 Z=0"   	  					//璁剧疆"Set Z=0"
#define UI_TEXT_ZCALIB             "Z \xf5\xc8"								//z杈冨噯"Z Calib."	
#define UI_TEXT_SET_P1            "\x90\x91\xf5\xc8\x9e P1"					//璁剧疆杈冨噯鐐?Set P1"
#define UI_TEXT_SET_P2            "\x90\x91\xf5\xc8\x9e P2"					//"Set P2"
#define UI_TEXT_SET_P3	          "\x90\x91\xf5\xc8\x9e P3"					//"Set P3"
#define UI_TEXT_CALCULATE_LEVELING "\xf9\xfa\xf5\xc8"						//姘村钩杈冨噯"Calculate Leveling"
#define UI_TEXT_LEVEL             "Delta \xf9\xfa\xf5\xc8"					//delta姘村钩杈冨噯	"Level delta"
#define UI_TEXT_SD_REMOVED       "SD\x89\xa4\xd5"							//sd鍗＄Щ闄?SD Card removed"
#define UI_TEXT_SD_INSERTED      "SD\x89\xfd\xa8"							//鎻掑叆"SD Card inserted" 

//#define UI_TEXT_STRING_SERIAL_USB     "USB"
//#define UI_TEXT_STRING_SERIAL_BT     "Bluetooth"
//#define UI_TEXT_STRING_SERIAL_AUTO     "Auto"
#define UI_TEXT_SERIAL            "Bluetooth: %oS"                 //
